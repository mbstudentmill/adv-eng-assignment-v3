...
class IMDbVisualizer:
    ...
    def create_genre_performance_chart(self, df: pd.DataFrame):
        ...
        ax1.barh(genre_stats_sorted['genres'], genre_stats_sorted['total_titles'])
        ...
        ax2.barh(genre_stats_rating['genres'], genre_stats_rating['avg_rating'])
    ...
    def create_decade_analysis_chart(self, df: pd.DataFrame):
        ...
        # Our data already has decade column, no need to create it
        # Group by decade
