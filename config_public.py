#!/usr/bin/env python3
"""
Public Configuration Loader - Advanced Data Engineering Assignment
Handles environment variables and API keys safely for public repository.
"""
...
class Config:
    ...
    def _validate_config(self):
        ...
        if missing_vars:
            ...
            logger.warning("Please set these variables in your .env file or system environment")
    ...
    def nasa_api_key(self) -> str:
        ...
        if not key:
            logger.warning("NASA_API_KEY not found, using DEMO_KEY (limited functionality)")
            return "DEMO_KEY"
        return key
...
if __name__ == "__main__":
    ...
    try:
        ...
        if cfg.nasa_api_key == "DEMO_KEY":
            print(f"NASA API Key: DEMO_KEY (limited functionality)")
        else:
